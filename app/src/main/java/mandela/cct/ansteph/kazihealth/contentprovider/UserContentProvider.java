...
public class UserContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://mandela.cct.ansteph.kazihealth.contentprovider.usercontentprovider/kazihealth");
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int retVal = db.delete(Tables.USER_TABLE, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.USER_TABLE, UserColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor c = db.query(Tables.USER_TABLE, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.USER_TABLE, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
