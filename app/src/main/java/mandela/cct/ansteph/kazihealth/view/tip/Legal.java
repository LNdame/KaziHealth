...
public class Legal extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    public static final String SAMPLE_FILE = "terms_and_conditions.pdf";
    ...
    void afterViews() {
       ...
       setTitle(getResources().getString(R.string.title_activity_legal));
    }
