...
public class DbHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public static  String DATABASE_NAME = "kazihealth.db";//kazihealth.sqlite

    public static  String DB_PATH= "/data/data/mandela.cct.ansteph.kazihealth/databases/";

    private final Context context;

    private static SQLiteDatabase kazihealthdb;
    ...
    public static void openDatabase () throws SQLException
    {
        ...
        kazihealthdb = SQLiteDatabase.openDatabase(path, null, SQLiteDatabase.OPEN_READWRITE);
